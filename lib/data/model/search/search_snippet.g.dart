...
class _$SearchSnippetSerializer implements StructuredSerializer<SearchSnippet> {
  ...
  Iterable<Object> serialize(Serializers serializers, SearchSnippet object,
    ...
    final result = <Object>[
      ...
      'chennelTitle',
      serializers.serialize(object.chennelTitle,
          specifiedType: const FullType(String)),
    ];
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'thumbnails':
          ...
          break;
        case 'chennelTitle':
          result.chennelTitle = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String;
          break;
      }
    }
...
class _$SearchSnippet extends SearchSnippet {
  ...
  _$SearchSnippet._(
    ...
    if (chennelTitle == null) {
      throw new BuiltValueNullFieldError('SearchSnippet', 'chennelTitle');
    }
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is SearchSnippet &&
        ...
        chennelTitle == other.chennelTitle;
  }
...
class SearchSnippetBuilder
  ...
  String _chennelTitle;
  String get chennelTitle => _$this._chennelTitle;
  set chennelTitle(String chennelTitle) => _$this._chennelTitle = chennelTitle;
  ...
  SearchSnippetBuilder get _$this {
    if (_$v != null) {
      ...
      _chennelTitle = _$v.chennelTitle;
      _$v = null;
    }
    return this;
  }
