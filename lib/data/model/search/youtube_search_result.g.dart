...
class _$YoutubeSearchResult extends YoutubeSearchResult {
  ...
  _$YoutubeSearchResult._({this.nextPageToken, this.pageInfo, this.items})
      : super._() {
    if (pageInfo == null) {
      throw new BuiltValueNullFieldError('YoutubeSearchResult', 'pageInfo');
    }
    if (items == null) {
  ...
  @override
  int get hashCode {
    return $jf($jc($jc($jc(0, nextPageToken.hashCode), pageInfo.hashCode),
        items.hashCode));
  }
